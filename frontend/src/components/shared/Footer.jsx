      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <div className="mb-4 md:mb-0 text-center md:text-left">
            ...
            <p className="text-sm text-gray-600">© 2025 Karm. All rights reserved.</p>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 mt-4 md:mt-0 text-center md:text-left">
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-2">
                ...
                <a href="https://www.linkedin.com/in/ankiitjhaa/" className="text-gray-600 hover:text-gray-800" aria-label="LinkedIn">
                ...
                <a href="https://www.instagram.com/ankiitjhaa_/" className="text-gray-600 hover:text-gray-800" aria-label="Instagram">
