...
const Job = ({ job }) => {
    ...
    return (
        <div className='p-6 rounded-xl shadow-lg bg-white border border-gray-200 hover:shadow-xl transition-all duration-300 group'>
            {/* Header Section */}
            ...
            <div className='flex items-center gap-4 mb-4'>
                ...
                <div>
                    ...
                    <p className='text-sm text-gray-500 flex items-center gap-1'>
                        <MapPin className="w-4 h-4 inline" /> India
                    </p>
                </div>
            </div>
            ...
            {/* Job Details Section */}
            <div className='mb-4'>
                <h1 className='font-bold text-xl text-gray-900 mb-2 group-hover:text-purple-700 transition-colors'>
                    {job?.title}
                </h1>
            ...
            <div className='flex flex-wrap items-center gap-2 mb-4'>
                <Badge 
                    variant="outline" 
                    className="flex items-center gap-1 text-blue-700 border-blue-200 bg-blue-50"
                >
                ...
                <Badge 
                    variant="outline" 
                    className="flex items-center gap-1 text-purple-700 border-purple-200 bg-purple-50"
                >
